...
<body>
    ...
    <div>
        ...
        <h3>Samples</h3>
        <ul>
        <li><a href="WebForm1.aspx">Teste</a></li>
        ...
        <li><a href="MapWithPushpinDelete.aspx">Google Map showing pushpin/polyline deletion</a></li>
        <li><a href="MapWithAutoMovingPushpins.aspx">Google Map with automatically moving pushpins</a></li>
        <li><a href="MapWithAutoMovingPushpinsAndDynamicBoundaries.aspx">Google Map with automatically moving pushpins and dynamically changing zoom and boundaries</a></li>
        ...
        <li><a href="MapClickEvent.aspx">Map click event example</a></li>
        <li><a href="PushpinsClickEvent.aspx">Pushpin click event example</a></li>
        <li><a href="PushpinsDragEvent.aspx">Pushpin drag event example</a></li>
        <li><a href="MapWithGeocoding.aspx">Google Map with Geocoding</a></li>
        <li><a href="MapWithReverseGeocoding.aspx">Google Map with Reverse Geocoding</a></li>
        ...
        <li><a href="MapWithZoomLevels.aspx">Google Map with Zoom Levels</a></li>
        </ul>
        </div>
    </form>
</body>
